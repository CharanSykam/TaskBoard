...
public class MainScreen implements ModelListener {
    ...
    public void update() {
        ...
        boardLayout.setCenter(null);
        // check is the current showing project still in task board
        // the project will be shown only if this project exist
        if(currentBoard.getProjectList().contains(currentProjectView.getProject())) {
